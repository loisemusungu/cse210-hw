...
class Program
{
    static void Main(string[] args)
    {
        ...
        Order order1 = new Order(new Customer("John Doe", new Address("123 Main St", "Springfield", "IL", "62701", "USA")));
        ...
        Order order2 = new Order(new Customer("Jane Smith", new Address("456 Elm St", "Springfield", "IL", "62702", "USA")));
